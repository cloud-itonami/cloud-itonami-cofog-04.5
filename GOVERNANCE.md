...
`cloud-itonami-cofog-04.5` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
- the advisor cannot directly dispatch a robot action or commit a public
  record.
- the Infrastructure Inspection Governor remains independent of the advisor.
...
licensing the operator's jurisdiction requires for road and bridge inspection work.
