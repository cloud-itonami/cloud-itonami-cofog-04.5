...
`cloud-itonami-cofog-04.5` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Infrastructure Inspection Governor.
- Treat road and bridge inspection as a safety-relevant domain: add tests for permission,
